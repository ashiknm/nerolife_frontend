  ...
  return (
    <div className="layout p-5 mb-5">
      <div className="mb-5 pb-10">
        <h1 className="text-center text-light fw-bold fs-1 p-5">IMAGES</h1>
        <div className=" flex justify-evenly align-items-center flex-wrap">
          ...
          <div  className="flex flex-column m-2" style={{ height: "500px" , width: "400px" }}>
            ...
            >
              <h1 className="image_video_button" onClick={()=>navigate('/contentsofshows')} >
                EVENTS
              </h1>
            </div>
          </div>
          ...
          <div className="flex flex-column m-2" style={{ height: "500px" , width: "400px" }}>
            ...
            <div
              ...
              className="flex align-items-center justify-center"
            >
              <h1 onClick={()=>navigate('/outletcontents')} className="image_video_button">
                OUTLETS
              </h1>
            </div>
          </div>
          <div className="flex flex-column m-2" style={{ height: "500px" , width: "400px" }}>
            ...
            <div
              ...
              className="flex align-items-center justify-center"
            >
              <h1 onClick={()=>navigate('/artistcontents')} className="image_video_button">
                ARTISTS
              </h1>
            </div>
          </div>
